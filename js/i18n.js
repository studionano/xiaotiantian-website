...
const translations = {
    en: {
        ...
        'hero.subtitle': '<p>· Auto-detect game rallies with AI</p><p>· Hawk-Eye colorful trajectory replay</p><p>· Support any frame rate video, shoot and analyze instantly</p><p>&nbsp;</p><p>Clean interface, ad-free — Focus on every shot.</p>',
    ...
    zh: {
        ...
        'nav.contact': '联系我们',
        'hero.title': '击智网球App',
        'hero.subtitle': '<p>· AI 自动识别回合</p><p>· 鹰眼炫彩轨迹回看</p><p>· 支持任意帧率视频，随拍随传随分析</p><p>&nbsp;</p><p>干净界面，纯净无广告——专注你的每一拍。</p>',
