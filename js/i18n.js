...
const translations = {
    en: {
        ...
        'nav.about': 'About',
        'nav.contact': 'Contact',
        'hero.title': 'AI Empowering Sports,<br>Creating Infinite Possibilities',
        'hero.subtitle': 'Auto-detect game rallies, instantly generate highlights, deeply analyze technical data, and scientifically plan personalized training!',
        'hero.cta': 'About XiaoTianTian Tech',
    ...
    zh: {
        ...
        'nav.about': '关于我们',
        'nav.contact': '联系我们',
        'hero.title': 'AI赋能体育，<br>智创无限可能',
        'hero.subtitle': '自动识别运动回合，瞬间生成精彩集锦，深度分析技术数据，科学规划个性化训练！',
        'hero.cta': '关于晓田田科技',
        'products.title': '击智网球',
