...
const translations = {
    en: {
        ...
        'hero.subtitle': '<p><strong>Auto-detect game rallies</strong></p><p><strong>Instantly generate highlights</strong></p><p><strong>Deeply analyze technical data</strong></p><p>Scientifically plan personalized training</p>',
    ...
    zh: {
        ...
        'nav.contact': '联系我们',
        'hero.title': '击智网球 App',
        'hero.subtitle': '<p><strong>自动检测比赛回合</strong></p><p><strong>即时生成精彩集锦</strong></p><p><strong>深度分析技术数据</strong></p><p>科学规划个性化训练</p>',
